...
export default function Header() {
    ...
    return (
        <header className='p-3 sm:p-6'>
            <div className='main-container flex justify-between items-center gap-5 px-6 py-3 border border-gray-300 rounded-full shadow-md'>
                ...
                <div className='flex flex-wrap items-center gap-6'>
                    ...
                    }
                    {
                        !isAuthenticated ?
                            ...
                            :
                            <Link to="/dashboard" className='flex items-center gap-1.5 text-sm bg-[var(--primary)] text-white px-3 py-1 rounded-full transition-all duration-200 ease-linear hover:bg-[var(--secondary)]'><MessageCircle size={14} /> Open Chat</Link>
                    }
                </div>
            </div>
        </header>
